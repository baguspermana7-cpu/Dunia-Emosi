...
const A=[[1280,720,'land169'],[1600,1000,'land1610'],[375,812,'phone'],[1280,512,'wide']];
...
try{await p.goto('http://localhost:'+PORT+'/games/film/batwheels-by-you/index.html',{waitUntil:'networkidle2',timeout:45000});await new Promise(r=>setTimeout(r,7000));await p.screenshot({path:'/tmp/byfix_'+t+'.png'});console.log('byfix',t,W+'x'+H);}catch(e){console.log(t,'ERR');}await p.close();}
await b.close();srv.close();console.log('BYFIX DONE');
