...
const TARGETS = [
  ...
  { id: 'F09', label: 'g19 splash',          url: '/games/pokemon-birds.html',
    ready: () => !!document.querySelector('canvas') },
  { id: 'F10', label: 'g20 splash',          url: '/games/ducky-volley.html',
    ready: () => !!document.querySelector('canvas') },
  { id: 'F11', label: 'g21 splash',          url: '/games/mario-pokemon.html',
    ready: () => !!document.querySelector('canvas') || !!document.querySelector('.hud-btn') },
  { id: 'F12', label: 'g22 candy',           url: '/games/monster-candy.html',
    ready: () => !!document.querySelector('canvas') },
  { id: 'F13', label: 'g23 runner',          url: '/games/pokemon-run.html',
    ready: () => !!document.querySelector('canvas') },
  { id: 'F14', label: 'g24 underwater',      url: '/games/pokemon-bawah-laut.html',
    ready: () => !!document.querySelector('canvas') },
  { id: 'F15', label: 'g25 math',            url: '/games/kuis-matematika.html',
