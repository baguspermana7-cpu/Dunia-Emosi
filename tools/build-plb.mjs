...
const html = tpl
  ...
  .replace(/<span id="stamp"><\/span>/, '<span id="stamp">v58.3 · ' + stamp + '</span>');
...
console.log('raw', raw, 'dropped(dupe/invalid)', dropped, '→ FINAL', final.length, '| flagship', flagTotal);
